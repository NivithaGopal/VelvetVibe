...
<%
    // Retrieve the payment ID and other details from the query parameters
    String paymentId = request.getParameter("paymentId");
    String bookingId = request.getParameter("bookingId"); // Assuming you pass bookingId as well
    ...
    boolean isUpdated = bookingDAO.updatePaymentStatus(Integer.parseInt(bookingId), paymentId);
    ...
    if (isUpdated) {
        ...
        response.sendRedirect("viewFavourites.jsp?message=Failed to update booking status");
    }
%>
